...
flowchart TD
    ...
    Scenario --> Simulater
    ActualSnapshot --> Simulater
    Simulater --> SimulationSnapshot
    SimulationSnapshot --> Overlay
```
...
| Alert      | Assetを元にした資産データ                                    | 総資産, 税引後流動資産 |
...
| 用語           | 意味                                                         | 例                     |
| -------------- | ------------------------------------------------------------ | ---------------------- |
| AgeCondition   | Scenario の前提条件                                          | 生年月日, インフレ率   |
| DateCondition | Scenario で取り扱う資産データ                                | 現金, 投資信託         |
| AssetCondition | Assetを元にした資産データ                                    | 総資産, 税引後流動資産 |
| MetricCondition | 毎月のシミュレーション結果に対して評価・実行するルール(後述) | -                      |
...
| MetricValue | Scenario の前提条件 | 生年月日, インフレ率 |
| StateValue | Scenario の前提条件 | 生年月日, インフレ率 |
| AlertValue | Scenario の前提条件 | 生年月日, インフレ率 |
